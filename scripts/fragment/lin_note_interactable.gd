...
@export var display_name: String = "林指导的便笺"
@export var interact_size: Vector2 = Vector2(72, 92)
...
func interact() -> void:
	...
	if fragment and fragment.has_method("show_lin_note"):
		fragment.show_lin_note()
...
func _find_fragment_scene() -> Node:
	...
	while current:
		if current.has_method("show_lin_note"):
			return current
