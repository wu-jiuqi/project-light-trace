...
const TARGET_SCENE := "res://scenes/fragments/fragment_0001.tscn"
const FRAME_DIR := "res://assets/papercraft/fragments/id0001/animation/frames"
...
func _ready() -> void:
	...
	if _frame_paths.is_empty():
		push_error("[Fragment0001Transition] No frames found in %s" % FRAME_DIR)
		_finish_transition()
		return
	_show_frame(0)
