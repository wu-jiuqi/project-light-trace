...
const TARGET_SCENE := "res://scenes/fragments/fragment_0003.tscn"
const FRAME_DIR := "res://assets/papercraft/fragments/id0003/animation/frames"
...
func _ready() -> void:
	...
	if _frame_paths.is_empty():
		push_error("[Fragment0003Transition] No frames found in %s" % FRAME_DIR)
		_finish_transition()
		return
	_show_frame(0)
	audio_player.play()
